...
## TODO Check with DevOps if this env variable can be used. DT_AGENT_PATH=/apps/Dynatrace/agent/lib64/libdtagent.so=name=social_publishing_gateway1.0!!server=cs1dyl001.cars.com:9991

ENVS=config-api.url=http://composite.cars.com/config-api/1.0/rest/config
LABELS=BIGIP_POOL=cars_dockerservice_image_processing_service_prd,ENV=prd
INSTANCES=1
