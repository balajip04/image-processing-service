...
def LOG_FILE = 'image-processing-service.log'

//hostName will be container id if running inside a docker container
def hostName = System.getenv("HOSTNAME")

if (hostName != null) {
	LOG_FILE = 'image-processing-service.' + hostName + '.log'
}

def logPath = '/apps/docker/logs/splunkme/image-processing-service'
...
logger("com.cars.image", ERROR, ["CONSOLE"], false)
